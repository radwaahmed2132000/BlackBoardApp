...
$teacheremail=$Quiz->GetTeacheremail($Quiz->GetCourseid($_GET['id']));
...
<body>
  ...
  <div class="container mt-5 mb-3 ">
    <div class="row">
      <div class="col-lg-4">
        <form class="login" method="post" action="../PHP/EditQuiz.php?id=<?php echo $_GET['id'];?>">
         <?php
           $Quizid =$_GET['id'];
           $Quiz=new Quiz();
           if(empty($_GET['id']))
         ...
         ?>
          <div  id="id01">
            <div class="Quiz">
                ...
                <input type="text" name="Quizname" id="Quizname" value="<?php echo $Quiz->Getname($Quizid)?>"><br>
                <label for="">Grade</label><br>
                <input type="number" name="Grade" id="Grade" value="<?php echo $Quiz->GetGrade($Quizid)?>" />
                <br>
                <label for="">Date of Quiz</label><br>
                <input type="date" name="date" id="date" value="<?php echo $Quiz->GetDateofQuiz($Quizid);?>">
                <br>
                <br>
                <label for="">Time of start</label><br>
                <input type="time" name="start" id="start" value="<?php echo $Quiz->GetstartofQuiz($Quizid);?>">
                <br>
                <br>
                <label for="">Time of end</label><br>
                <input type="time" name="end" id="end" value="<?php echo $Quiz->GetEndofQuiz($Quizid);?>">
                <br><br>
            ...
            <button class="btn btn-primary" name="submit" type="submit">Edit Quiz</button>
            <h5 >
